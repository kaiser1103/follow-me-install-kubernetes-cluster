...
- [07-3.部署 kube-proxy 组件](#07-3部署-kube-proxy-组件)
    ...
    - [检查启动结果](#检查启动结果)
    - [查看监听端口和 metrics](#查看监听端口和-metrics)
...
tcp        0      0 192.168.112.100:10249    0.0.0.0:*               LISTEN      76419/kube-proxy
tcp        0      0 192.168.112.100:10256    0.0.0.0:*               LISTEN      76419/kube-proxy
```
...
TCP  10.254.0.1:443 rr
  -> 192.168.112.101:6443          Masq    1      0          0
  -> 192.168.112.102:6443          Masq    1      0          0
  -> 192.168.112.100:6443          Masq    1      0          0
>>> 192.168.112.101
IP Virtual Server version 1.2.1 (size=4096)
Prot LocalAddress:Port Scheduler Flags
  -> RemoteAddress:Port           Forward Weight ActiveConn InActConn
