...
node01   Ready     <none>    3d        v1.10.4
node02   Ready     <none>    3d        v1.10.4
...
elasticsearch-logging-1                  1/1       Running   0          2m        172.30.39.8   node02
fluentd-es-v2.0.4-hntfp                  1/1       Running   0          5m        172.30.39.6   node02
kibana-logging-7445dc9757-pvpcv          1/1       Running   0          5m        172.30.39.7   node02
...
``` bash
[k8s@master fluentd-elasticsearch]$ kubectl logs kibana-logging-7445dc9757-pvpcv -n kube-system -f
...
1. 通过 kube-apiserver 访问：
    ...
    Elasticsearch is running at https://192.168.112.100:6443/api/v1/namespaces/kube-system/services/elasticsearch-logging/proxy
    Kibana is running at https://192.168.112.100:6443/api/v1/namespaces/kube-system/services/kibana-logging/proxy
    ```

    浏览器访问 URL： `https://192.168.112.100:6443/api/v1/namespaces/kube-system/services/kibana-logging/proxy`
...
1. 通过 kubectl proxy 访问：
    ...
    浏览器访问 URL：`http://192.168.112.100:8086/api/v1/namespaces/kube-system/services/kibana-logging/proxy`
