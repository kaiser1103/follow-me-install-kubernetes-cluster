...
1. 通过 kube-apiserver 或 kubectl proxy 访问：
    ...
    https://192.168.112.100:6443/apis/metrics.k8s.io/v1beta1/nodes
    https://192.168.112.100:6443/apis/metrics.k8s.io/v1beta1/nodes/<node-name>
    https://192.168.112.100:6443/apis/metrics.k8s.io/v1beta1/pods
    https://192.168.112.100:6443/apis/metrics.k8s.io/v1beta1/namespace/<namespace-name>/pods/<pod-name>
